...
func (c *InformacionProveedorController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddInformacionProveedor(&v); err == nil {
...
func (c *InformacionProveedorController) GetOne() {
	...
	v, err := models.GetInformacionProveedorById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *InformacionProveedorController) GetAll() {
	...
	l, err := models.GetAllInformacionProveedor(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /:id [put]
func (c *InformacionProveedorController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.InformacionProveedor{IdProveedor: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateInformacionProveedorById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *InformacionProveedorController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteInformacionProveedor(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}

...
type Evaluacion struct {
	...
	FuncionalidadAdicional string    `orm:"column(funcionalidad_adicional)"`
	Reclamaciones          string    `orm:"column(reclamaciones)"`
	ReclamacionSolucion    string    `orm:"column(reclamacion_solucion)"`
	ServicioVenta          string    `orm:"column(servicio_venta)"`
	Procedimientos         string    `orm:"column(procedimientos)"`
	Garantia               string    `orm:"column(garantia)"`
	GarantiaSatisfaccion   string    `orm:"column(garantia_satisfaccion)"`
	PuntajeTotal           float64   `orm:"column(puntaje_total)"`
	Clasificacion          string    `orm:"column(clasificacion)"`
}
